...
public class MI5 extends PowerRunner {
	...
	public static String dailer_Act = ".activities.TwelveKeyDialer";
	...
	public static String music_Pack = "com.miui.player";
	public static String music_Act = ".ui.MusicBrowserActivity";

	public static String video_Pack = "com.qiyi.video";
	public static String video_Act = "org.qiyi.android.video.MainActivity";

	public static String camera_Pack = "com.android.camera";
	...
	public static int call(int times, String number)
		...
		try {
			for (count = 0; count < times; count++) {
				...
				CM.hold(30000);
//				CM.hold(2000);
				if (CM.waitForId("com.android.incallui:id/endButton", 2000))
	...
	public static void watchPhone() {
		ud.registerWatcher(PhoneCall, new UiWatcher() {
			...
			public boolean checkForCondition() {
				...
				if (CM.waitForId(
						"com.android.phone:id/incomingCallWidget_photo", 600)) {
					Rect r;
					try {
						r = CM.findObjectByRid(
								"com.android.phone:id/incomingCallWidget_photo",
								600).getBounds();
						ud.drag(r.centerX(), r.centerY(), 10, r.centerY(), 3);
						if (CM.waitForId(
	...
	public static int browserTest(int times) throws IOException,
		...
		try {
			...
			if (CM.waitForNewApp("com.android.browser", 2000)) {
				CM.waitForId("com.android.browser:id/scrollView", 1000);
				for (count = 0; count < times; count++) {
					for (int i = 0; i < 4; i++) {

//						CM.scroll(ud, CM.DOWN);
//						CM.hold(2000); // 主页图标
//						ud.click(210, 817);// 百度图标
//
//						CM.hold(9000); // 主页图标
//						ud.click(755, 1850);
						//home-baidu
						CM.findObjectByRid("com.android.browser:id/action_home",1000).click();
						CM.hold(2000);
						CM.findObjectByText("百度", 1000).click();
						CM.hold(9000);
						CM.findObjectByRid("com.android.browser:id/action_home",1000).click();
						//
...
//					CM.findObjectByText("视频", 1000).click();
				//录像
				CM.findObjectByRid(
						"com.android.camera:id/v6_module_picker", 1000)
						.click();
				CM.hold(3000);
				CM.findObjectByRid(
						"com.android.camera:id/v6_shutter_button_internal", 1000)
						.click();
				CM.hold(30000);
				CM.findObjectByRid(
						"com.android.camera:id/v6_shutter_button_internal", 1000)
...
//						CM.findObjectByText("照片", 1000).click();
	...
	private static void startMusic() throws UiObjectNotFoundException {
		...
		CM.hold(3000);
		CM.findObjectByRid("com.miui.player:id/pause", 1000)
				.click();
		ud.pressBack();
		ud.pressBack();
	}

...
public class EPlus3_H extends PowerRunner {
	...
	public static String dailer_Act = "com.oneplus.contacts.activities.OPDialtactsActivity ";
	...
	public static String music_Pack = "com.netease.cloudmusic";
	public static String music_Act = "com.netease.cloudmusic.activity.LoadingActivity";
...
//			CM.findObjectByRid("com.tencent.mm:id/gx", 1000).click();
			CM.findObjectByRid("com.tencent.mm:id/gj", 1000).click();
			...
			for (count = 0; count < times; count++) {
				...
				for (int j = 0; j < 3; j++)// takephoto capture
				{
					CM.findObjectByRid(
							"com.oneplus.camera:id/primary_capture_button",
							1000).dragTo(
									CM.findObjectByRid("com.oneplus.camera:id/primary_capture_button",	1000),
									10000);
					CM.hold(4000);
				}
				CM.hold(3000);
	...
	private static void startMusic() throws UiObjectNotFoundException {
		...
		CM.hold(3000);
		CM.findObjectByRid("com.netease.cloudmusic:id/minPlayBtn", 1000)
				.click();
		ud.pressBack();
		ud.pressBack();
	}

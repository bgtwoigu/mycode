...
public class ExpListViewAdapterWithCheckbox extends BaseExpandableListAdapter {
    ...
    public ExpListViewAdapterWithCheckbox(Context context, ExpandableListView listView,
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                ...
                if (isChecked) {
                    ...
                    if (isAllChildClicked) {
                        ...
                        if(!(DataHolder.checkedChilds.containsKey(child.name))){
                            DataHolder.checkedChilds.put(child.name,
                                    parentGroup.name);
                        }
                        checkAll = false;
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded,
        ...
        holder.imageView
                .setImageResource(groupStatus[groupPosition] == 0 ? R.drawable.ic_arrow_downward_black_24dp

...
class MailConstruct(object):
    ...
    def initHandler(self):
        ...
        self.listMailTo.append("fengyingzhen@oneplus.cn")
    ...
    def mailBodyGenerate(self):
        ...
        msgBody += "<br>For any assistance or query, Please contact me at fengyingzhen@oneplus.cn"
...
if __name__ == '__main__':
    ...
    listTo = ["fengyingzhen@oneplus.cn"]

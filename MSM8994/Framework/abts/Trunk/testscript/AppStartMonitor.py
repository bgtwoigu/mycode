    ...
    for strAppName in dictAppName:
        ...
        try:
            ...
            if controlCurrentApp is not None:
                processLogcat = subprocess.Popen(['adb', '-s', strDeviceID, 'shell', 'logcat'], stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
                ...
                if dictCurrentAppTimeInfo.get("AppStart", None) is None or dictCurrentAppTimeInfo.get("ButtonRelease", None) is None:
                    ...
                    logger.info("%s Start Time Use %s ms" % str(strAppName, (intCurrentAppStartTime)))
...
if __name__ == '__main__':
    ...
    main("73ffec58", "E:\\", {"AppList": {"Phone": "com.android.contacts"}})

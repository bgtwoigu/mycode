...
class TestRunner(object):
    ...
    def __init__(self, strTempPath, strDeviceID, strProjectKey, listTestScriptList, dictTestParameterList, strTestScriptPoolPath):
        self.strTestResultPath = strTempPath
        self.strDeviceID = strDeviceID
        self.strProjectKey = "DEMO"
        ...
        if self.initTestDevice() is False:
        ...
        for strTestScriptName in self.listTestScriptList:
            ...
            try:
                ...
                CurrentTestScript.main(self.strDeviceID, strCurrentTestTempPath,
                                       self.dictTestParameterList.get(strTestScriptName, {}))      # execute test script 
            except Exception, e:
                logger.exception("Exception Caught")
                boolResult = False
                strLastError = str(e)

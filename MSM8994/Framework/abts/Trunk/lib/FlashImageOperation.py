...
def flashJenkinsBuild(strDeviceID, strBuildPath, listImageIgnore=['userdata.img']):
    """
    ...
    dictImageConfig = getImageConfigFromFile(
        os.path.join(strBuildImgPath, "md5checksumtool.ini"))                #analyze this file to flash image list  --modify by libin
